...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/scripts/lint_seat.py --all --seats-dir ${CLAUDE_PLUGIN_ROOT}/seats
# or a single seat:
python3 ${CLAUDE_PLUGIN_ROOT}/scripts/lint_seat.py ${CLAUDE_PLUGIN_ROOT}/seats/<id> [--level strict] [--explain]
```
